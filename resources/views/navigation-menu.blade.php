    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin.requests') }}" :active="request()->routeIs('admin.requests')">
                        {{ __('Requests') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin.salons') }}" :active="request()->routeIs('admin.salons')">
                        {{ __('Salons') }}
                    </x-jet-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="mx-10">
                    <x-jet-dropdown  align="right" width="48" class="mx-10">
                        ...
                        <x-slot name="content">
                            <x-jet-dropdown-link href="{{ route('salon.join_view') }}">
                                {{ __('Join Salon') }}
                            </x-jet-dropdown-link>
    
                            <x-jet-dropdown-link href="{{ route('salon.create') }}">
                                {{ __('Create Salon') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>    
