...
<body class="antialiased ">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
                ...
                <button onclick="window.location.href='{{ route('register') }}';" id="navAction"
                    class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Sign up</button>
                @endif
                @endauth
            </div>
            @endif
            ...
            <div class="mt-9 md:mt-11 lg:mt-16" id="contact">
                ...
                <div role="list" aria-label="Our team members" class="flex flex-wrap items-center justify-around mt-2 ">
                    <div role="listitem" class="flex flex-col items-center justify-center m-6 focus:outline-none">
                        ...
                        <p class="text-base font-semibold leading-none text-gray-800 mt-2">ALLOUI Abdelrauf</p>
                        <p class="text-base leading-none text-gray-600 mt-2">Developer</p>
                    </div>
                    <div role="listitem" class="flex flex-col items-center justify-center m-6 focus:outline-none">
                        <img src="{{ asset('img/asset.png') }}" alt="Display avatar of RADJAI Nabil" role="img"
                            class="w-12">
                        <p class="text-base font-semibold leading-none text-gray-800 mt-2">RADJAI Nabil</p>
                        <p class="text-base leading-none text-gray-600 mt-2">Developer</p>
                    </div>
                </div>
    ...
    <footer class="bg-white">
        ...
        <a href="https://www.freepik.com/free-photos-vectors/background" class="text-gray-500 center">Site created by
            ALLOUI Abdelraouf & RADJAI Nabil</a>
    </footer>
