...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="faq">
        <img src="{{ asset('img/black_pattern.png') }}" alt="black pattern background" class="absolute w-full h-64 md:h-96 object-center object-fit z-0" />
        <div class="relative flex flex-col items-center justify-center sm:px-0 px-6 z-20 pb-32">
            ...
            <div class="mt-9 md:mt-11 lg:mt-16" id="contact">
                ...
                <div class="flex justify-center items-center" >
                    <button class="mt-4 md:mt-6 py-3 px-6 bg-black hover:bg-indigo-700 rounded text-white text-center font-medium text-base focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-800">Contact us</button>
                </div>
            </div>
    ...
    <a href="https://www.freepik.com/free-photos-vectors/background" class="text-gray-500 center">Site created by ALLOUI Abdelraouf & RADJAI Nabil</a>
    </footer>
